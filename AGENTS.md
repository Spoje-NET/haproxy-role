# WARP.md - Working AI Reference for haproxy-ansible-role

## Project Overview
**Type**: Unknown
**Purpose**: HAProxy Role
**Status**: Active
**Repository**: git@github.com:Spoje-NET/haproxy-role.git
...
git clone git@github.com:Spoje-NET/haproxy-role.git
cd haproxy-ansible-role
